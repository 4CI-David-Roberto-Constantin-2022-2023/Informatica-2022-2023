...
public class FrigoriferoTest
{
    public static void main (String [] args){
        ...
        f1.setTemperaturaFrigo(5); f2.setTemperaturaFrigo(4); f3.setTemperaturaFrigo(11);
        System.out.println("Temperatura: Frigorifero-1: " + f1.getTemperaturaFrigo() + " Frigorifero-2: " + f2.getTemperaturaFrigo() + " Frigorifero-3 " + f3.getTemperaturaFrigo());
        f1.setTemperaturaFreezer(-4); f2.setTemperaturaFreezer(5); f3.setTemperaturaFrigo(0);
        System.out.println("Temperatura: Freezer-1: " + f1.getTemperaturaFreezer() + " Frigorifero-2: " + f2.getTemperaturaFreezer() + " Frigorifero-3 " + f3.getTemperaturaFrigo());
        
        //v0.6
        
        f1.accendi(); f2.accendi();
        System.out.println("Stato dei frigoriferi: \nFrigorifero-1: " + f1.getAcceso() + "\nFrigorifero-2: " + f2.getAcceso() + "\nFrigorifero-3: " + f3.getAcceso());
        f2.spegni();
        System.out.println("Stato dei frigoriferi: \nFrigorifero-1: " + f1.getAcceso() + "\nFrigorifero-2: " + f2.getAcceso() + "\nFrigorifero-3: " + f3.getAcceso());
        
        f1.setConsumoKwat(20);
        Frigorifero f4 = new Frigorifero(f1);
        System.out.println("Frigorifero 1: " + f1.toString() + "\n\nFrigorifero 2: " + f2.toString() + "\n\nFrigorifero 3: " + f3.toString() + "\n\nFrigorifero 4: " + f4.toString() + "\n");
